...
func (h *PostgresTrafficTicketSQLXRepository) GetPaginated(w http.ResponseWriter, r *http.Request) {
...
func (h *PostgresTrafficTicketSQLXRepository) Create(w http.ResponseWriter, r *http.Request) {
